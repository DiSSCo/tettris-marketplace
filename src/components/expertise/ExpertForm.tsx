...
import FormBuilder from 'components/taxonomicService/taxonomicServiceFormComponents/FormBuilder';
                            ...
                            <Col>
                                <Card className="w-100 px-4 py-3">
                                    ...
                                    {!completed &&
                                        <Row>
                                            <Col>
                                                <FormBuilder formTemplate={TaxonomicExpertFormJSON}
